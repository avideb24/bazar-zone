                ...
                <div className="md:w-1/2 space-y-3">
                    ...
                    <form className="text-[color:var(--text-primary)] space-y-3">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <input type="text" className="flex grow px-3 py-1 bg-transparent border border-slate-400 outline-none" placeholder="Your Name..." id="name" />
                        </div>
                        {/* email */}
                        <div className="flex items-center gap-2">
                            <label htmlFor="email" className="w-16">Email</label>
                            <input type="email" className="flex grow px-3 py-1 bg-transparent border border-slate-400 outline-none" placeholder="Your Email..." id="email" />
                        </div>
                        {/* email */}
